...
class PlayerStateTest {
  ...
  void playerState_copy_createsIndependentInstance() {
    ...
    PlayerState original =
        new PlayerState("id123", "Alice", PlayerRole.HUMAN, pos, input, 100, 3, true, false);
    ...
    assertNotSame(
        original.getPosition(), copy.getPosition(), "Position cannot be the same object.");
    assertNotSame(
        original.getInputState(), copy.getInputState(), "InputState cannot be the same object.");
  }
  ...
  void addScore_increasesScore() {
    ...
    PlayerState player =
        new PlayerState(
            ...
            "Bob",
            PlayerRole.PHANTOM,
            new Position(new int[] {0, 0}, dummyMap),
            new InputState(0, 0),
            0,
            0,
            true,
