...
/**
 * Tracks the mutable state of a specific player during a match, including position, score, and
 * connection status.
 */
public final class PlayerState {
  ...
  public InputState getRealInput() {
    return realInput;
  }
  ...
  public int getRemainingAbility() {
    return remainingAbility;
  }
  ...
  public void setRemainingAbility(int set) {
    this.remainingAbility = set;
  }
